...
Plan approved -> orchestrator activates
  ...
  â”‚         Each worker paired with its critic (see agents.md)
  â”‚
  Step 3: REVIEW - Critic evaluates worker output, produces score
  â”‚         If score < 80 -> worker fixes -> critic re-reviews (max 3 rounds)
  â”‚         If 3 rounds fail -> ESCALATE (see agents.md)
  â”‚
  Step 4: VERIFY - Compile, render, run code, check outputs
  â”‚         If verification fails -> fix -> re-verify (max 2 attempts)
  â”‚
