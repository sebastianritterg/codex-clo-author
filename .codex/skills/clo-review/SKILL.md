...
5. If send to referees -> editor selects referee dispositions and pet peeves from the journal's **Referee pool** (see ~/.codex/skills/clo-workflow/references/journal-profiles.md )
...
2. The target journal name (for ~/.codex/skills/clo-workflow/references/journal-profiles.md  calibration)
...
- **Referees vary.** Different dispositions and pet peeves mean running `$clo-review --peer` twice gives different feedback - just like submitting to two journals would.
