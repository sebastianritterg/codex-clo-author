...
<!--
HOW TO USE: Fill this in manually OR let $clo-discover (interactive interview) generate it.
...
| Top field | [e.g., JDE, JHE, RAND JE, AEJ:EP, AEJ:Applied] |
| Strong field | [e.g., JPubE, JHR, Regional Studies, Journal of Economic Geography] |
...
- Primary default: Python
- Co-default: Stata
- Also supported: R and Julia
- If the repo declares another language in AGENTS.md, README.md, or project docs, follow the repo.
- Prefer Python for ETL, automation, geospatial work, and analysis pipelines.
- Prefer Stata for econometric implementation or replication when the project already centers Stata.
